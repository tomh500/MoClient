...
void ShowRegionMessage(int regionCode) {
    ...
    switch (regionCode) {
    case 1:
        message = L"Square-Delta公测，完全免费发布，您的地区：中国大陆";
        break;
    case 2:
        message = L"Square-Delta公测，完全免费发布，您的地区：台湾地区";
        break;
    case 3:
        message = L"Square-Delta公测，完全免费发布，您的地区：日本";
        break;
    default:
    ...
    //    HandleCpuTypeAndAppend(vendor, brand, filePath, fps);
      ...
      //  wstring messageG = L"检测到 GPU: " + gpuInfo;
       ...
       // system("color 0F");
        ...
        CopyFileOptimized(L"src\\resources\\Square_Installed.cfg", L"..\\..\\..\\cfg\\Square_Installed.cfg");
